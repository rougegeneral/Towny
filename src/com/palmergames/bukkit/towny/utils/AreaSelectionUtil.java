...
public class AreaSelectionUtil {
	...
	public static List<WorldCoord> selectWorldCoordArea(TownyBlockOwnerObject owner, WorldCoord pos, String[] args) throws TownyException {
	...
	public static List<WorldCoord> selectWorldCoordAreaRect(TownyBlockOwnerObject owner, WorldCoord pos, String[] args) throws TownyException {
	...
	public static List<WorldCoord> selectWorldCoordAreaCircle(TownyBlockOwnerObject owner, WorldCoord pos, String[] args) throws TownyException {
	...
	public static List<WorldCoord> filterOwnedBlocks(TownyBlockOwnerObject owner, List<WorldCoord> selection) {
	...
	public static boolean isOnEdgeOfOwnership(TownyBlockOwnerObject owner, WorldCoord worldCoord) {
